...
SCRIPT_DIR="."
OUT_FILE="${SCRIPT_DIR}/officehome_ap.txt"

JFPD_LAMBDA_VALUES=(0.003 0.005 0.008 0.01 0.015 0.02 0.03 0.05)
TRAIN_BATCH_SIZE_VALUES=(28 32 40)
EVAL_BATCH_SIZE=16
DATASET="office-home"
SOURCE_LIST="data/office-home/Art.txt"
TARGET_LIST="data/office-home/Product.txt"
TEST_LIST="data/office-home/Product.txt"
NUM_CLASSES=65
MODEL_TYPE="ViT-B_16"
