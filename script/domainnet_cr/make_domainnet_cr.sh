...
OUT_FILE="${SCRIPT_DIR}/domainnet_cr.txt"

TRAIN_BATCH_SIZE_VALUES=(190 90 45)
JFPD_LAMBDA_VALUES=(0.0001 0.001 0.01 0.1)
JFPD_ALPHA=0.5

EVAL_BATCH_SIZE=16
DATASET="DomainNet"
BASE_NAME="domainnet_cr"
SOURCE_LIST="data/DomainNet/clipart_train.txt"
TARGET_LIST="data/DomainNet/real_train.txt"
TEST_LIST="data/DomainNet/real_test.txt"
NUM_CLASSES=345
MODEL_TYPE="ViT-B_16"
